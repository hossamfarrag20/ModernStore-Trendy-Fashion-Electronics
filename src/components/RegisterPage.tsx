...
export const RegisterPage: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.username.trim()) {
      ...
      if (userRegistry[formData.username]) {
    ...
    if (!formData.email.trim()) {
      ...
      const existingUser = Object.values(userRegistry).find(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(
        `تم إنشاء حساب جديد بنجاح للمستخدم: ${formData.username}`
      );
        ...
        >
          <div className="glass-card p-8 shadow-2xl hover:shadow-3xl transition-all duration-500">
            ...
            >
              ...
              {successMessage && (
                <motion.div
                  className="glass border border-green-300/50 dark:border-green-600/50 text-green-600 dark:text-green-400 px-4 py-3 rounded-xl backdrop-blur-sm"
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`appearance-none block w-full pl-10 pr-10 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white ${
